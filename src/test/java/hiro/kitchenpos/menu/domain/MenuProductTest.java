...
class MenuProductTest {
    ...
    void create(final int quantity) {
        assertDoesNotThrow(() -> new MenuProduct(new Product("치킨", BigDecimal.TEN, new InmemoryPurgomalumClient()), quantity));
    }
    ...
    void menu_product_quantity_less_than_zero(final int quantity) {
        assertThatThrownBy(()-> new MenuProduct(new Product("치킨", BigDecimal.TEN, new InmemoryPurgomalumClient()), quantity))
